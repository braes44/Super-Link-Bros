...
function create() {
    ...
    try {
        ...
        player = this.physics.add.sprite(100, 450, 'link'); // Posiciona a Link justo encima de la plataforma inicial
        player.setBounce(0.2);
        player.setCollideWorldBounds(true);
        player.setSize(14, 14); // Ajusta el tamaño de la hitbox de Link para mejor colisión
        this.physics.add.collider(player, platforms);

        // Habilitar depuración visual de hitboxes
...
function resetLevel(scene) {
    ...
    switch (currentLevel) {
        case 1:
            ...
            enemy1.setSize(14, 14); // Ajusta el tamaño del enemigo
